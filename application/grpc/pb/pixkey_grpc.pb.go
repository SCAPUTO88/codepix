...
type PixServiceClient interface {
	RegistePixKey(ctx context.Context, in *PixKeyRegistration, opts ...grpc.CallOption) (*PixKeyCreatedResult, error)
...
func (c *pixServiceClient) RegistePixKey(ctx context.Context, in *PixKeyRegistration, opts ...grpc.CallOption) (*PixKeyCreatedResult, error) {
	out := new(PixKeyCreatedResult)
	err := c.cc.Invoke(ctx, "/github.com.codeedu.codepix.PixService/RegistePixKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PixServiceServer interface {
	RegistePixKey(context.Context, *PixKeyRegistration) (*PixKeyCreatedResult, error)
...
func (UnimplementedPixServiceServer) RegistePixKey(context.Context, *PixKeyRegistration) (*PixKeyCreatedResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegistePixKey not implemented")
}
...
func _PixService_RegistePixKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PixKeyRegistration)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PixServiceServer).RegistePixKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.codeedu.codepix.PixService/RegistePixKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixServiceServer).RegistePixKey(ctx, req.(*PixKeyRegistration))
	}
...
var PixService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RegistePixKey",
			Handler:    _PixService_RegistePixKey_Handler,
		},
		{
			MethodName: "Find",
